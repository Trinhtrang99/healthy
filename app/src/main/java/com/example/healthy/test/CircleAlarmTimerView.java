package com.example.healthy.test;
...
public class CircleAlarmTimerView extends View {
    ...
    // Default color
    private static final int DEFAULT_CIRCLE_COLOR = Color.parseColor("#9B9A9B");
    private static final int DEFAULT_CIRCLE_BUTTON_COLOR = Color.parseColor("#9B9A9B");
